...
**절대 금지:**
- 사용자가 준 이야기의 논지/메시지를 바꾸지 마세요
- 없는 인물을 만들어내지 마세요
- 없는 사건을 추가하지 마세요
- 불교/종교적 내용을 임의로 넣지 마세요

**해야 할 것:**
- 사용자 입력의 핵심 메시지를 그대로 유지
- 감정 묘사만 보강 (구체적인 감정, 상황 디테일)
- 극적 전개 (갈등 → 절정 → 깨달음) 구조화
- 이야기꾼처럼 몰입감 있게 전달

**구조:**
1. 훅(15초): 핵심 메시지나 질문으로 시작
2. 상황 설정: 사용자가 준 내용 그대로
3. 전개/갈등: 감정선 강화
4. 절정: 가장 중요한 순간 강조
5. 교훈/여운: 사용자가 전하려는 메시지로 마무리
